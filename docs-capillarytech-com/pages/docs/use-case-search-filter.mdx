...
You want to search for a customer using a combination of details—**first name**, **date of birth**, and **city**. In this case, you're doing a full search. You’ll enter the complete first name (e.g., _Frodo_), the full date of birth, and the full city name (e.g., _Mount Doom_). No partials.
