...
- [Create a card series](/card#create-card-series) with either auto-generated card numbers or manually generated card numbers.
- Auto-assign card numbers to customers during registration or first transaction after card-series creation.
- Manually issue cards to customers through [member care](/manage-cards) and integration platform (APIs).
- Issue one or more cards to customers from a card series.
- Create a separate [loyalty program for each card series](/create-a-multi-loyalty-program).
...
- **Card issue**: Card issue means linking cards to customers. The following are the three possible scenarios that can happen during registration or post-registration. For details, see [issue card to a customer](/manage-cards)
...
<Image src="https://files.readme.io/23a601b-card1.png" alt="Card1" caption=" " />
...
<Image src="https://files.readme.io/5d8bd15-card2.png" alt="Card2" caption=" " />

c. Enter a **name** for the status label.

<Image src="https://files.readme.io/077be1f-card3.png" alt="Card3" caption=" " />
...
<Image src="https://files.readme.io/27a7054-card4.png" alt="Card4" caption=" " />

5. Click **Update**.

<Callout kind="info">
  After successfully configuring the card at the org level, [create a card series](/card#create-card-series), [generate card numbers](/generate-download-card-numbers), and [issue cards to customers](/manage-cards).
</Callout>
...
Before configuring the card series, you need to set an [org-related card configuration](/card#card-configurations-org-level).
...
<Image src="https://files.readme.io/1f02b32-8fuz8p3tTBM9hl63x64dQsADEKmULHu7PQ.png" alt="8fuz8p3tTBM9hl63x64dQsADEKmULHu7PQ" caption=" " />
...
8. In **Card generation**, choose the options - _Customer registered with this card series, Customer registered from specific Org Unit_, or Any registered customer to generate the card numbers dynamically. The card generation option does not appear for the physical card series type when the Enable card number generation is disabled.

<Image src="https://files.readme.io/4895446-OEQ2jb-ZIrI0e4OZ1vRdrND7bAH8s6Dd8Q.png" alt="OEQ2jb ZIrI0e4OZ1vRdrND7bAH8s6Dd8Q" caption=" " />
...
<Image src="https://files.readme.io/9a34ed1-Mmy2GaryMbTzdmRh6sv632Ix23MUUTNMsA.png" alt="Mmy2GaryMbTzdmRh6sv632Ix23MUUTNMsA" caption=" " />
...
<Image src="https://files.readme.io/3acbc05-ZVuiNF0N03kYlSN4ZwviSgjwarpejJCUdA.png" alt="ZVuiNF0N03kYlSN4ZwviSgjwarpejJCUdA" caption=" " />
...
<Image src="https://files.readme.io/dd86734-_F7O1cwIUZtpGLudXc7YoTtjVeueSXHvKg.png" alt="F7O1cwIUZtpGLudXc7YoTtjVeueSXHvKg" caption=" " />
...
<Image src="https://files.readme.io/85e3b88-53ZKY987lbI5ybhUBqn-5QtfMmMUxRl5vA.png" alt="53ZKY987lbI5ybhUBqn 5QtfMmMUxRl5vA" caption=" " />

12. Click **Create series**.

<Callout kind="info">
  - After successfully creating a card series, [generate card numbers](/generate-download-card-numbers) and [issue cards to customers](/manage-cards).
...
4. In the **Select card series**, choose card series using the drop-down list. To see the options in the drop-down list configure the card series during card series creation. For details, [see create card series](/create-card-series).
5. In the **Number of cards**, enter the number of cards that you want to generate.
6. In **Status**, select the card status using the drop-down list. In the drop-down list, you can select only Not issued status options. To see the options in the drop-down list configure the global settings. For details, see [card-related configurations (Org Level)](/card-related-configurations-org-level).
7. Click **Generate cards**.

<Image src="https://files.readme.io/ab27f7f-generateCards.png" alt="GenerateCards" caption=" " />
...
<Image src="https://files.readme.io/3f2fb49-generateCards2.png" alt="GenerateCards2" caption=" " />
...
<Image src="https://files.readme.io/f306058-downloadcards.png" alt="Downloadcards" caption=" " />

<Callout kind="info">
  - Generated card numbers remain on the system for 30 days.
  - After successfully generating card numbers, you can issue cards to customers either using [Member Care](/manage-cards) or API integration.
</Callout>
...
<Image src="https://files.readme.io/8cd198a-ModifyCard1.png" alt="ModifyCard1" caption=" " />

4. Click the more options (...) icon  > **Edit**.

<Image src="https://files.readme.io/14e773a-ModifyCard2.png" alt="ModifyCard2" caption=" " />
...
<Image src="https://files.readme.io/6604442-c61c17e-hqTN1tjx3E4ySus9tXxkS47LH8mj_AttDg.png" alt="C61c17e hqTN1tjx3E4ySus9tXxkS47LH8mj AttDg" caption=" " />
...
<Image src="https://files.readme.io/8a02f81-4d85424-XjNhb2Rv_3WdTYZPvhA1iKUqD-hN1aEF6g.png" alt="4d85424 XjNhb2Rv 3WdTYZPvhA1iKUqD hN1aEF6g" caption=" " />
...
<Image src="https://files.readme.io/647cc93-de5767f-ZLeUNv7eaFwXEPhgzhir6h8GMvReJk-RTw.png" alt="De5767f ZLeUNv7eaFwXEPhgzhir6h8GMvReJk RTw" caption=" " />

<Image src="https://files.readme.io/49916f7-c209d3d-0TnYq7rCUagdwC9ARr3WXjTZNwBgS9h12w.png" alt="C209d3d 0TnYq7rCUagdwC9ARr3WXjTZNwBgS9h12w" caption=" " />
