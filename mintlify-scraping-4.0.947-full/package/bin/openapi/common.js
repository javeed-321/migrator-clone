...
export const createOpenApiFrontmatterContent = ({ openApiMetaTag, version, deprecated, metadata, extraContent, }) => {
...
export const createOpenApiFrontmatter = async ({ filename, ...input }) => {
    ...
    Object.values(OpenAPIV3.HttpMethods).forEach((method) => {
        if (method in pathItemObject) {
            ...
            if (options.writeFiles && (!fse.pathExistsSync(targetPath) || options.overwrite)) {
                ...
                writePromises.push(options.writeFile
