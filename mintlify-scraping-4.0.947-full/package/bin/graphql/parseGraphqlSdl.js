import { buildSchema, isEnumType, isInputObjectType, isInterfaceType, isListType, isNonNullType, isObjectType, isScalarType, isSpecifiedScalarType, isUnionType, print, validateSchema, valueFromASTUntyped, } from 'graphql';
const isVisibleName = (name) => !name.startsWith('__');
const withDescription = (description) => description === undefined || description === null ? {} : { description };
const withDeprecation = (deprecationReason) => deprecationReason === undefined || deprecationReason === null ? {} : { deprecationReason };
function normalizeGraphqlTypeRef(type) {
...
export function parseGraphqlSdl(sdl) {
...
//# sourceMappingURL=parseGraphqlSdl.js.map