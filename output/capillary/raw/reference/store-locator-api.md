---
updatedAt: 2026-03-13T09:49:09.000Z
---
...
<body>
  <div class="doc-container">
    <ul class="nav-list">
      <li class="nav-item">
        <a href="https://docs.capillarytech.com/update/reference/overview#/" class="nav-link"><strong>1. Overview</strong></a>
      </li>
      <li class="nav-item">
        <a href="https://docs.capillarytech.com/update/reference/overview#introduction" class="nav-link">Introduction</a>
      </li>
      <li class="nav-item">
        <a href="https://docs.capillarytech.com/update/reference/overview#use-case" class="nav-link">Use cases</a>
      </li>
      <li class="nav-item">
        <a href="https://docs.capillarytech.com/update/reference/overview#implementation" class="nav-link">Implementation</a>
      </li>
