---
updatedAt: 2026-07-08T05:16:07.000Z
---
...
[API doc for issue user reward](https://docs.capillarytech.com/reference/post-issue-user-reward-mobileold)<br />[API doc for issue bulk reward](https://docs.capillarytech.com/reference/post-issue-user-reward-email-copy-1)
...
<Image src="https://files.readme.io/16a6454-Screenshot_2023-08-17_at_12.37.37_PM.png" align="center" border={true} />
...
<Image src="https://files.readme.io/be68a96-Screenshot_2023-08-17_at_12.36.36_PM.png" align="center" border={true} />
...
{  
    ...
    "reward": {  
        ...
        "imageUrl": "<https://assets.example.com/rewards/06f0da4b-dd0b-48fe-b20d-1cadc76.html>,  
        "thumbnailId": "c886f064-2b3f-4c19-9e86-7f7e5ab5ae04",  
        "thumbnailUrl": "<https://assets.example.com/rewards/06f0da4b-dd0b-48fe-b20d-1cadc76.html>,  
        "termAndConditionsId": "820a3d7f-2601-405b-9f56-4a3ba8e9df73",  
        "termAndConditionsUrl": "<https://assets.example.com/rewards/06f0da4b-dd0b-48fe-b20d-1cadc76.html>,  
        "tier": null,  
        "label": null,  
        "priority": 1,   
        "group": null,  
...
6. **Personalized Rewards Based on Customer Groups:**  Sarah is a loyal customer who enjoys browsing her favorite brand's rewards catalog. She belongs to two special customer groups: "**Frequent Shoppers**" and **"Premium Members**."<br />Rewards Available:
...
7. **Reward Experience for a Non-Customer Group Member:** Emma has not joined any specific customer groups, but she is still an important customer to the brand.<br />Rewards Available:
