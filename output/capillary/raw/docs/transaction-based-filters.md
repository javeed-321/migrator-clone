---
updatedAt: 2026-07-30T07:22:15.000Z
---
...
<Callout icon="📘" theme="info">
  ...
  The Extended Fields filters are not available by default. If you want to use these filters while creating audiences, raise a Jira ticket to the PST ticket to have the required transaction extended fields onboarded for your organization.
</Callout>
...
<Image src="https://files.readme.io/8feb3de-BE59Pb4N3YvyKqu-mVzwmSkahwlkB6HySA.png" align="center" width="80%" border={true} />
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        You can select duration either by <Anchor target="_blank" href="https://docs.capillarytech.com/docs/common-filter-optionsin-filters#/relative-days">relative days</Anchor> or <Anchor target="_blank" href="https://docs.capillarytech.com/docs/common-filter-optionsin-filters#/specific-dates">specific days</Anchor>.
    ...
    <tr>
      ...
      <td>
        You can get the customers whose transactions are in the selected range.<br />You can either include or exclude a given condition.
...
<Image src="https://files.readme.io/b60fa5e-UML0fyFqenrxuUIo9RUQCnlL4hYc_kIepA.png" align="center" width="smart" border={true} />
...
<Image src="https://files.readme.io/9803626-Z0BAHctqv-ZgziG-yf4lShEqktI385QyWQ.png" align="center" width="smart" border={true} />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This option lets you filter customers by store(s) at which the activity is done. You can also select stores by zones and concepts.<br />For details on how to configure, see [Store hierarchy](https://docs.capillarytech.com/docs/common-filter-optionsin-filters#/store-hierarchy)
      </td>
    </tr>
...
<Image src="https://files.readme.io/8e06a34-gdVzGNYG8uIRJqltfLyrxFEQ73wMnWt2LA.jpg" align="center" width="smart" border={true} />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This lets you filter customers by shopped day.<br />You can choose one or more days of a week (Monday - Sunday).
...
Fetches customers who have not visited stores in the last x days after the first, second or last visit.<br />For example, you can get customers who have not visited in the last 30 days after their 1st visit.

<Image src="https://files.readme.io/a6ba2e0-scAUzStnhomLXF_a3TSlRJBQjQFulKX28Q.jpg" align="center" width="smart" border={true} />
...
<Callout icon="⚠️" theme="warning">
  **Important**
  ...
  If your audience filter is configured to exclude outlier bills, those transactions are not included when calculating the lifetime transaction amount. As a result, customers whose total spend meets the eligibility threshold only when outlier bills are included may not qualify for the campaign if their qualifying spend falls below the configured threshold.
</Callout>

Filters customers based on a specific transaction amount during a particular period.

<Image src="https://files.readme.io/b34645b-evNDp2COp7Q83crjtuJragRMNaD_Z5VH_A.jpg" align="center" width="smart" border={true} />
...
<Image src="https://files.readme.io/90bbd74-download.png" align="center" width="smart" border={true} />
...
<Image src="https://files.readme.io/1c336eb-hI7dMImCE3ARU2B_jmyNzPiVAzDAjg6BjA.png" align="center" width="smart" border={true} />
...
<Image src="https://files.readme.io/978c821-TmkhQovLcsmXE4I4XpOfRbCgeNI8-jmguw.png" align="center" width="smart" border={true} />
...
<Image src="https://files.readme.io/bb7debb-oMSyGinklb0aKN5BC_EMgY4a-3m-Nwmelw.png" align="center" width="smart" border={true} />
