---
updatedAt: 2026-07-09T07:15:39.000Z
---
...
> **Note:** When you select one or more stores for a filter (for example, **Registered store**), the audience group description now shows the selected store names. Descriptions of audience groups created earlier don't reflect this change. Newly created audience groups show the store names correctly.
