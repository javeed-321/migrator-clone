...
8. Are there any ways to ingest coupon codes automatically if the coupon code is generated from POS?\
   ...
   <https://docs.capillarytech.com/reference/issue-single-coupon>\
   <https://docs.capillarytech.com/reference/issue-bulk-coupons>\
   <https://docs.capillarytech.com/reference/upload-coupons-batch>
